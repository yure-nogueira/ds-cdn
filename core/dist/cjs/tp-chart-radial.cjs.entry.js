...
const TpChartRadial = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'a2367bbbc3cc559fd3333b581d5221a3203d39b3', class: color_function.createColorClasses(color, {
                'tp-chart-radial': true,
                [`tp-chart-radial--${size}`]: Boolean(size),
            }) }, index.h("svg", { key: '76a96a8559525cd314d5dd4539b763b26d085a82', class: "tp-chart-radial__container", viewBox: "0 0 36 36" }, index.h("circle", { key: '984deea52c673b0de9a1ed70f6ffc2b78f39a623', class: "tp-chart-radial__track", cx: "18", cy: "18", r: "16" }), reversedItems.map((item, index$1) => {
        ...
        })), index.h("div", { key: 'd3527043eb6ec88c04084e90a0620b9294eef6fc', class: "tp-chart-radial__text-container" }, index.h("slot", { key: '33a94e08c1be307141bd25457bd4113ffc7c84f7', name: "title" }), index.h("slot", { key: 'cd7beea2b51ea14969880f5646accd67793dd13f', name: "subtitle" }))));
    }
