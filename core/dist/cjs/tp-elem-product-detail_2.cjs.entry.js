...
const TpElemProductDetail = class {
    constructor(hostRef) {
        ...
        this.addToCartEvent = index.createEvent(this, "addToCartEvent", 7);
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '32b1d4ae9a96b46d503f87107844edb9a7541247' }, index.h("div", { key: '83bb86fde455cbab7493efe2147daf4b4738b74f', class: "product-detail" }, index.h("div", { key: '3ee465c9a7f04300c3124542eef4e97a2dbbfa23', class: "product-detail__left" }, index.h("div", { key: '299e16b50b293822d1988e92863c7bffbe5eb7ae', class: "product-detail__image-container" }, index.h("slot", { key: '0e843bd7635f1f16cc1abab1c2e589c622ddf244', name: "image" }))), index.h("div", { key: '7cb9b114383df2e621d5acd700fc8b8634396f75', class: "product-detail__right" }, index.h("slot", { key: 'd04aa8aad4c5f484a02d95283ae2fa47acae6341', name: "title" }), index.h("div", { key: 'a40ce79b642bfe5ef2434020457a9dc19340e2b4', class: "product-detail__price-container" }, index.h("slot", { key: '6dbc3ee83cb934e7b9816ac34b85adf553bca29d', name: "regular-price" }), index.h("slot", { key: 'c09bdbea5a3b4c2ba173e9273885e9ea48f753fd', name: "price" })), index.h("slot", { key: '52d790d9a0e1aabc64bd2b25c9f14c6ae960ed08', name: "description" }), index.h("slot", { key: 'c6f50c2e13815dc976662b1e54f7f0685240d06a', name: "stock" }), index.h("div", { key: 'cbff6ca58094bd26dbbdceee6a31b3879e36b5cc', class: "product-detail__info-container" }, index.h("slot", { key: '72e34d7e0d0d769f89e301b4028fd3b30078306f', name: "sku" }), index.h("slot", { key: 'c75db07129e27efc9dc98db6ea35317e3aa465b4', name: "attributes" }), index.h("slot", { key: '1ee06c8b26acc312482a316cb9c06277c92b6dd0', name: "categories" })), type === 'external' ? (index.h("slot", { name: "action" })) : (index.h("div", null, index.h("tp-plusminus", { class: "product-detail__plusminus", "use-slot": "false", value: value, min: 1, max: stockQuantity ? stockQuantity : 9, "automatic-disabled": true }), index.h("ion-button", { color: "brand", onClick: () => this.onAddToCart(id, value), disabled: stockStatus !== 'instock' }, "Add to cart")))))));
    }
};
...
const TpImagesCarousel = class {
    ...
    getCarouselImages() {
        ...
        if (!images.length) {
            return (index.h("swiper-slide", null, index.h("ion-skeleton-text", { animated: true, "tp-component": "tp-images-carousel" })));
        }
        return zoom
            ? images.map(({ src, alt }) => (index.h("swiper-slide", { class: "images-carousel__slide" }, index.h("div", { class: "swiper-zoom-container" }, index.h("img", { src: src, alt: alt })))))
            : images.map(({ src, alt }) => (index.h("swiper-slide", { class: "images-carousel__slide" }, index.h("img", { src: src, alt: alt }))));
    }
    getCarouselThumbs() {
        const { images, thumbs, thumbsParams } = this;
        return (index.h("swiper-container", Object.assign({ class: {
                ['images-carousel__thumbs']: true,
                ['images-carousel__thumbs--show']: thumbs,
            }, "slides-per-view": images.length }, thumbsParams), images.map(({ src, alt }) => (index.h("swiper-slide", { class: "images-carousel__thumb" }, index.h("img", { src: src, alt: alt }))))));
    }
    render() {
        ...
        return (index.h(index.Host, { key: '579a901e4be5d45944f3eb71dba9efddbaddf119', class: "images-carousel", style: {
                '--aspect-ratio': `${aspectRatio}`,
                '--thumbs-margin-top': `${thumbsParams.spaceBetween}`,
            } }, index.h("swiper-container", Object.assign({ key: '9c8b178841dba29fba7f9901159162394070690a', class: "images-carousel__container" }, carouselParams, extraCarouselParams), carouselImages), carouselThumbs));
    }
};
TpImagesCarousel.style = TpImagesCarouselStyle0;

exports.tp_elem_product_detail = TpElemProductDetail;
exports.tp_images_carousel = TpImagesCarousel;

//# sourceMappingURL=tp-elem-product-detail_2.cjs.entry.js.map