...
const TpBase = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'aa9b6c972cf8b386905a6532015b9d5a33f50594', class: color_function.createColorClasses(color, {
                'tp-base': true,
            ...
            }) }, index.h("slot", { key: '05a187d8c6546fbff3af9be24906a730593b4f95', name: "start" }), index.h("slot", { key: 'bd30bf6cb980936beaa11d62a400f89fd0e4227d', name: "middle" }), index.h("slot", { key: '92b041ddab7e82f651a5f809daf7202f07d476d7', name: "end" }), index.h("slot", { key: 'fc61ebe2c0619ec6d284be367bc1cdb799836e11' })));
    }
};
TpBase.style = TpBaseStyle0;

exports.tp_base = TpBase;

//# sourceMappingURL=tp-base.cjs.entry.js.map