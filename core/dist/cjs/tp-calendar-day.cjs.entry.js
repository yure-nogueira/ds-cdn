...
const TP_CALENDAR_DAY = {
    icons: {
        check: index.getAssetPath('./assets/tp-check.svg'),
    },
};
...
const TpCalendarDay = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '616205625c62dc047c90c9cf49862bfb087fbb76', class: {
            ...
            } }, index.h("div", { key: '3c3cc80be721384a1a8e7cb52d8480f11fdbc8ea', class: "tp-calendar-day__date" }, index.h("div", { key: 'f54a61381dcc4fde6b146e6de5442ad85312997f', class: "tp-calendar-day__container" }, index.h("ion-text", { key: 'ab0f7807a43e13a8172ef66012376221e5cba8d6', class: "tp-calendar-day__text" }, index.h("slot", { key: '2954aab84b1823ef6cd8d3a63276289e2bd1df0e' })), index.h("ion-icon", { key: '8762e4c3870538b779e561e0c188bdc245e4dedf', class: "tp-calendar-day__checked-icon", src: TP_CALENDAR_DAY.icons.check })))));
    }
    static get assetsDirs() { return ["assets"]; }
};
TpCalendarDay.style = TpCalendarDayStyle0;

exports.tp_calendar_day = TpCalendarDay;

//# sourceMappingURL=tp-calendar-day.cjs.entry.js.map