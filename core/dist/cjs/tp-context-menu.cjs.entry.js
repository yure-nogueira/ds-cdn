...
const TP_CONTEXT_MENU = {
    icons: {
        moreVertical: index.getAssetPath('./assets/tp-more-vertical.svg'),
    },
};
...
const TpContextMenu = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '0f96af8f8054583a8df02047d7658b296bf2b2f6', class: color_function.createColorClasses(color, {
                'tp-context-menu': true,
                'tp-context-menu--collapsed': collapsed,
            }) }, index.h("ion-button", { key: '1f691c321e470d0338a6f2cfd3b8b84ebdcc2d3c', "icon-only": true, onClick: () => this.toggle(), class: "tp-context-menu__button", fill: "clear",
            // @ts-ignore
            size: "sm" }, index.h("ion-icon", { key: '5e38ac60ab71668f90b1749b59c1ff8b7f029538', slot: "icon-only", class: "tp-context-menu__icon", src: TP_CONTEXT_MENU.icons.moreVertical })), index.h("div", { key: '185e1312cfd024448ea348e9ca95532931d53cda', class: "tp-context-menu__content" }, index.h("div", { key: '2d026f9b887ba65bb7472a252f7df7d90b81cce8', class: "tp-context-menu__top" }, index.h("ion-button", { key: 'c045328d30dd373a09806a2370ffb13b9ccb571a', "icon-only": true, onClick: () => this.toggle(), class: "tp-context-menu__inner-button", fill: "clear",
            // @ts-ignore
            size: "sm" }, index.h("ion-icon", { key: '84361b02334dc57bd58480cc63d583414f17573e', slot: "icon-only", class: "tp-context-menu__inner-icon", src: TP_CONTEXT_MENU.icons.moreVertical })), index.h("div", { key: '252d962d04c122830f3e930e57310f5344c9e127' }, index.h("slot", { key: '397e9c4c11cc8e0e0ae16014f4acb74e88402969', name: "item" }))), index.h("slot", { key: 'a0c2b4508665070fb36d5a37e0502ae62d16d385', name: "info" }))));
    }
    static get assetsDirs() { return ["assets"]; }
    get host() { return index.getElement(this); }
};
TpContextMenu.style = TpContextMenuStyle0;

exports.tp_context_menu = TpContextMenu;

//# sourceMappingURL=tp-context-menu.cjs.entry.js.map