...
const TpElemProductSearch = class {
    ...
    async onUpdatedSearchTerm() {
        ...
        try {
            const { products } = await currency_filter.ApiProduct.getSearchedProducts(this.searchTerm, { signal: this.currentAbortController.signal });
            if (this.searching) {
    ...
    getDropdownItems() {
        ...
        return this.products.length
            ? this.products.map(({ name, shortDescription, images, onSale, regularPrice, price, permalink, }) => (index.h("ion-item", { href: permalink, lines: "full", "tp-spacingy": "s08", color: color, onMouseEnter: () => this.onMouseEnterSearchItem(), onMouseLeave: () => this.onMouseLeavesSearchItem() }, index.h("div", { class: "product-search__item-wrapper" }, index.h("div", { onMouseEnter: () => this.onMouseEnterImage(images[0].src), onMouseLeave: () => this.onMouseLeavesImage(), class: "product-search__image-container" }, index.h("img", { class: "product-search__image", src: images[0].src, alt: "" })), index.h("div", { class: "product-search__info" }, index.h("div", { class: "product-search__info-left" }, index.h("ion-text", { "tp-type": "p16x" }, index.h("span", null, name)), index.h("ion-text", { class: "product-search__description", "tp-type": "p14x" }, index.h("span", null, shortDescription.replace(/<\/?p>/g, '')))), index.h("div", { class: "product-search__info-right" }, onSale && regularPrice && (index.h("ion-text", { class: "product-search__sale-price", "tp-type": "p12x" }, currency_filter.currency(regularPrice, 'pt-br'))), index.h("ion-text", { "tp-type": "p14x" }, currency_filter.currency(price, 'pt-br'))))))))
            : [];
    }
    render() {
        const { color, searchPageUrl, maxDropdownHeight, products, searchTerm, dropdownLocked, searching, searchbarHovering, } = this;
        const dropdownItems = this.getDropdownItems();
        return (index.h(index.Host, { key: 'aac8af4edc663a0cda6d44eecf52e2b2206fcfa6', class: color_function.createColorClasses(color, {
                'product-search': true,
                'product-search__searchbar-hover': !color && searchbarHovering,
            }) }, index.h("tp-autocomplete", { key: 'c137078da23814218a88e8287dd99d54e7a7c277', color: color, locked: dropdownLocked, style: { '--tp-dropdown-max-height': `${maxDropdownHeight}px` } }, index.h("tp-input-container", { key: '5bc4ff1b194a84e8b1bcfe8865061adcaca2c6fe', class: "product-search__searchbar", color: color }, index.h("ion-searchbar", { key: 'feec3e1cda5b59b043ea840296d75efb1aa77430', inputMode: "search", debounce: PRODUCT_SEARCH.DEBOUNCE_TIME, mode: "md", "search-icon": "./../../../../assets/tp-search.svg", "clear-icon": "./../../../../assets/tp-x.svg", placeholder: "Buscar produto", color: color, onMouseEnter: () => this.onMouseEnterSearchbar(), onMouseLeave: () => this.onMouseLeavesSearchbar() })), searching && (index.h("div", { key: 'e4a82fbed8da4b840d0187c7b0dc32bde101b526', class: "product-search__loader-container" }, index.h("div", { key: '9442fb0a805a01388cd69ad9630fc7534ccdc7f9', class: "product-search__loader" }))), index.h("tp-dropdown", { key: 'd827e47944263672b8686407af84be862d471d31' }, dropdownItems, searchTerm && !products.length && (index.h("ion-item", { key: '032f761762356569449546603e63626c9f628116', lines: "full", "tp-spacingy": "s08", color: color }, index.h("ion-text", { key: 'd312fa3c05f92f2ad6dc86ba1c0753cf03e4ccdc', "tp-type": "p14x" }, "Nenhum produto encontrado"))), Boolean(products.length) && (index.h("ion-item", { key: '6985f45938a1706a272ad2f6bf67fbadfd3553aa', href: `${searchPageUrl}?query=${searchTerm}`, lines: "full", "tp-spacingy": "s08", color: color, onMouseEnter: () => this.onMouseEnterSearchItem(), onMouseLeave: () => this.onMouseLeavesSearchItem() }, index.h("ion-text", { key: '408fa995702f247ce355a42b480154cf1c235915', "tp-type": "p14x", class: "product-search__search-page-link" }, "Ver todos os resultados"))))), index.h("div", { key: '5be11d34e15c46c1fdd423845267a58eac48fc4d', class: {
                'product-search__lightbox': true,
                'product-search__lightbox--show': this.lightboxParams.display,
            } }, index.h("img", { key: '6c76f4e9cdf47a3715d3478c399266d864d03f0c', src: this.lightboxParams.imageSrc, alt: "" }))));
    }
...
exports.tp_elem_product_search = TpElemProductSearch;

//# sourceMappingURL=tp-elem-product-search.cjs.entry.js.map