...
const TpHero = class {
    ...
    render() {
        return (index.h(index.Host, { key: '795694207e38cce6e7b29013d6e41a2940bda609', class: "hero" }, index.h("swiper-container", Object.assign({ key: '6332d2721cf2540e78c5a6cf8b2702111880e90d', class: "hero__slider" }, this.params), index.h("slot", { key: '0b26db7e0bb454b1b69ead71bd7a84c1e5ae6ded' }))));
    }
};
TpHero.style = TpHeroStyle0;

exports.tp_hero = TpHero;

//# sourceMappingURL=tp-hero.cjs.entry.js.map