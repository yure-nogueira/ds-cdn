...
const TP_CALENDAR = {
    icons: {
        chevronRight: index.getAssetPath('./assets/tp-chevron-right.svg'),
        chevronLeft: index.getAssetPath('./assets/tp-chevron-left.svg'),
...
const TpCalendar = class {
    constructor(hostRef) {
        ...
        this.tpCalendarChange = index.createEvent(this, "tpCalendarChange", 7);
        this.tpTimeframeToggle = index.createEvent(this, "tpTimeframeToggle", 7);
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '5e27be6090e8e459a81d48b0f2d7f6b4aa724197', class: color_function.createColorClasses(color, {
                'tp-calendar': true,
            }) }, index.h("div", { key: 'c711d4777e20cc34b1a31dc8a8d45a1d451a3288', class: "tp-calendar__header" }, index.h("div", { key: '7f7fafd6a1b16000052b55a81de82568e109b050', class: "tp-calendar__header-left" }, index.h("ion-button", { key: 'e446f88f7f4f6771c96711dbc49ee0b28077abae',
            // @ts-ignore
            size: "xxs", fill: "clear", onClick: () => this.onCalendarChange(TP_CALENDAR.directions.left) }, index.h("ion-icon", { key: '81bf9d92dfd63b80c5cf15523a5aa1ef0db0068c', slot: "icon-only", src: TP_CALENDAR.icons.chevronLeft })), index.h("ion-text", { key: '4f5fa81a002131d28ce36187a2b2a421fb22f42f', class: "tp-calendar__label", "tp-type": "p16b" }, label), index.h("ion-button", { key: '62e10458116b5c015bb5afc485d18cab71937afb',
            // @ts-ignore
            size: "xxs", fill: "clear", onClick: () => this.onCalendarChange(TP_CALENDAR.directions.right) }, index.h("ion-icon", { key: '4742e798e86de6606f7a1b89d73b83c6155641ff', slot: "icon-only", src: TP_CALENDAR.icons.chevronRight }))), index.h("div", { key: 'df057882f35d872d2e8cf298112b16abfa39d4e0', class: "tp-calendar__header-right" }, index.h("ion-button", { key: '8279e40e9b19f28a1ca151bd09125d050f1c69b3',
            // @ts-ignore
            size: "xxs", fill: "clear", onClick: () => this.onTimeframeToggle() }, timeframe !== null && timeframe !== void 0 ? timeframe : initialTimeframe, index.h("ion-icon", { key: '773ee8b5e86d099d509c18d6646a6f48570cec9c', class: "tp-calendar__icon", slot: "end", src: TP_CALENDAR.icons.chevronDown })))), index.h("div", { key: '529dbe6e85492b5057c0afebd42be51bc89071c1', class: "tp-calendar__content" }, index.h("div", { key: '313d138f8bc1a1506bacfedcc865c79edf77e49f', class: "tp-calendar__content-header" }, TP_CALENDAR.weekdays.map((day) => (index.h("div", { class: "tp-calendar__week-day" }, index.h("ion-text", { "tp-type": "p12", color: "neutral-8" }, day))))), index.h("div", { key: '5db0ec2f22684ec4484633291be6568e1a61cb65', class: "tp-calendar__container", ref: (el) => (this.container = el) }, index.h("slot", { key: '97aaf4ab173d6f2c7502eafbdb259ee6c89d3dfe' })))));
    }
    static get assetsDirs() { return ["assets"]; }
};
TpCalendar.style = TpCalendarStyle0;

exports.tp_calendar = TpCalendar;

//# sourceMappingURL=tp-calendar.cjs.entry.js.map