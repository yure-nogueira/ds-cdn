...
const TpPlusMinus = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.tpChange = index.createEvent(this, "tpChange", 7);
        this.tpChangeAlt = index.createEvent(this, "tpChangeAlt", 7);
        this.iconMinus = index.getAssetPath('./assets/tp-minus-circle.svg');
        this.iconPlus = index.getAssetPath('./assets/tp-plus-circle.svg');
        this.onClick = (status) => {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '5511c82c3171f6155b5024c1d1debec225cad976', "from-stencil": true, class: color_function.createColorClasses(color, {
                'tp-plusminus': true,
                [`tp-plusminus--disabled-${disabled}`]: disabled !== undefined,
                [`tp-plusminus--${size}`]: size !== undefined,
            }) }, index.h("ion-icon", { key: '8d731659cbcc26f92ed5286abb6aaf4153e9c183', class: "tp-plusminus__icon tp-plusminus__icon--minus", src: iconMinus, onClick: () => this.onClick(TpPlusMinusStatus.MINUS) }), useSlot ? index.h("slot", null) : value !== null && value !== void 0 ? value : 0, index.h("ion-icon", { key: 'e8402cb37eef56824bbe8b34618d02447944b376', class: "tp-plusminus__icon tp-plusminus__icon--plus", src: iconPlus, onClick: () => this.onClick(TpPlusMinusStatus.PLUS) })));
    }
...
TpPlusMinus.style = TpPlusminusStyle0;

exports.tp_plusminus = TpPlusMinus;

//# sourceMappingURL=tp-plusminus.cjs.entry.js.map