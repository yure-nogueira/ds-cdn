...
const TpBanner = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '2281c0351b23b9af4e62cfe8913aea3f01f189dd', class: {
                banner: true,
                ['banner--animated']: animate,
                [`banner--align-${alignment}`]: true,
            } }, index.h("div", { key: 'bf2debe53374182009ef20f0af3b994561912ae9', class: "banner__container" }, index.h("slot", { key: 'fa59ca5b66c2673cf8b743cd19b00dfb5113221a', name: "image" }), index.h("div", { key: 'cb8f25b43c94ab259506b9ab3ffa217cdc210d6b', class: "banner__content" }, index.h("slot", { key: '757601674507bd1dcad20ac6a7dee817e7e7916f', name: "content" })))));
    }
    get host() { return index.getElement(this); }
};
TpBanner.style = TpBannerStyle0;

exports.tp_banner = TpBanner;

//# sourceMappingURL=tp-banner.cjs.entry.js.map