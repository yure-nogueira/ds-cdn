...
const TpAlertFixed = class {
    ...
    render() {
        const { color } = this;
        return (index.h(index.Host, { key: '9f433a935a5c204939579c89c3fa342a602a3d34', class: color_function.createColorClasses(color, {
                'tp-alert-fixed': true,
            }) }, index.h("div", { key: 'bf428cc2db214ff4fd8f05bed3c30ea8d660689d', class: "tp-alert-fixed__container" }, index.h("slot", { key: '9842230871c45efe9c9cfe6cecef1d4b0cad0cf8', name: "icon" }), index.h("slot", { key: '91595cff05c87c6c04fad80606126262ece4f198', name: "text" }))));
    }
};
TpAlertFixed.style = TpAlertFixedStyle0;

exports.tp_alert_fixed = TpAlertFixed;

//# sourceMappingURL=tp-alert-fixed.cjs.entry.js.map