...
const TpFontZoom = class {
    constructor(hostRef) {
        ...
        this.fontUpIcon = index.getAssetPath('./assets/tp-type-minus.svg');
        this.fontDownIcon = index.getAssetPath('./assets/tp-type-plus.svg');
        this.min = 1;
        this.max = 5;
        this.step = 1;
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'c0902223dc70f5c30a2be957efaf5b9da1b3e854', "from-stencil": true }, index.h("ion-range", { key: 'a95438600d3ac8e5af352a6a21d41a3f847739a9', onIonChange: (ev) => onRangeChange(ev.detail.value), min: min, max: max, step: step, value: fontSizeToValue(this.value) }, index.h("ion-icon", { key: 'c48ce19dcc90978a245618ffc301f68068595dda', slot: "start", src: fontUpIcon }), index.h("ion-icon", { key: '7431c17fc89a3fd307ea35a815d4aa2bbfc4bf96', slot: "end", src: fontDownIcon }))));
    }
    static get assetsDirs() { return ["assets"]; }
};
TpFontZoom.style = TpFontZoomStyle0;

exports.tp_font_zoom = TpFontZoom;

//# sourceMappingURL=tp-font-zoom.cjs.entry.js.map