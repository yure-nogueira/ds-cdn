...
const TpTooltip = class {
    ...
    render() {
        ...
        let skeleton;
        if (loading) {
            skeleton = (index.h("div", { class: "tp-tooltip__content-skeleton" }, index.h("ion-skeleton-text", { class: "tp-tooltip__skeleton", animated: true })));
        }
        return (index.h(index.Host, { onMouseenter: (event) => {
            ...
            }) }, index.h("div", { class: "tp-tooltip__trigger-container", onClick: (event) => {
                this.toggle(event);
            } }, index.h("slot", { name: "trigger" })), index.h("div", { class: "tp-tooltip__content" }, index.h("slot", null)), skeleton));
    }
};
