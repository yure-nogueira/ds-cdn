...
const TpQuestion$1 = /*@__PURE__*/ proxyCustomElement(class TpQuestion extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return TpQuestionStyle0; }
}, [1, "tp-question", {
        "color": [513],
        "collapsed": [1540],
        "texto": [1]
...
function defineCustomElement$1() {
    ...
    const components = ["tp-question"];
    components.forEach(tagName => { switch (tagName) {
        case "tp-question":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, TpQuestion$1);
            }
            break;
    } });
}

const TpQuestion = TpQuestion$1;
const defineCustomElement = defineCustomElement$1;

export { TpQuestion, defineCustomElement };

//# sourceMappingURL=tp-question.js.map