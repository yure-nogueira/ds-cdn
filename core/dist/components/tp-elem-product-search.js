...
import { d as defineCustomElement$4 } from './autocomplete.js';
import { d as defineCustomElement$3 } from './dropdown.js';
import { d as defineCustomElement$2 } from './input-container.js';
...
const TpElemProductSearch$1 = /*@__PURE__*/ proxyCustomElement(class TpElemProductSearch extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
    ...
    static get style() { return TpElemProductSearchStyle0; }
}, [2, "tp-elem-product-search", {
        "color": [513],
        "searchPageUrl": [513, "search-page-url"],
        "maxDropdownHeight": [514, "max-dropdown-height"],
        "searchTerm": [32],
        "products": [32],
        "lightboxParams": [32],
        "searchbarHovering": [32],
        "searchItemHovering": [32],
        "dropdownLocked": [32],
        "searching": [32],
        "currentAbortController": [32]
    }, [[0, "ionInput", "onSearchInput"], [0, "ionFocus", "onSearchFocus"], [0, "ionBlur", "onSearchBlur"]], {
        "searchTerm": ["onUpdatedSearchTerm"]
    }]);
function defineCustomElement$1() {
    ...
    const components = ["tp-elem-product-search", "tp-autocomplete", "tp-dropdown", "tp-input-container"];
    components.forEach(tagName => { switch (tagName) {
        case "tp-elem-product-search":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, TpElemProductSearch$1);
            }
            break;
...
const TpElemProductSearch = TpElemProductSearch$1;
const defineCustomElement = defineCustomElement$1;

export { TpElemProductSearch, defineCustomElement };

//# sourceMappingURL=tp-elem-product-search.js.map