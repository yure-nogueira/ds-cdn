...
function fadein(target, delay = 0, stagger = 0, duration = 300) {
    return gsapWithCSS.fromTo(target, { opacity: 0 }, {
        opacity: 1,
        ease: 'power1.inOut',
...
function slideup(target, delay = 0, stagger = 0, duration = 300) {
    return gsapWithCSS.fromTo(target, { opacity: 0, y: 60 }, {
        opacity: 1,
        y: 0,
        ease: 'power1.inOut',
        duration: duration / 1000,
...
function slideleft(target, delay = 0, stagger = 0, duration = 300) {
    return gsapWithCSS.fromTo(target, { opacity: 0, x: 60 }, {
        opacity: 1,
        x: 0,
        ease: 'power1.inOut',
        duration: duration / 1000,
...
function slideright(target, delay = 0, stagger = 0, duration = 300) {
    return gsapWithCSS.fromTo(target, { opacity: 0, x: -60 }, {
        opacity: 1,
        x: 0,
        ease: 'power1.inOut',
...
const groupAnimationCss = ".sc-tp-group-animation-h{display:inline-block;position:relative}.sc-tp-group-animation-h.tp-animation.sc-tp-group-animation-s>*,.sc-tp-group-animation-h.tp-animation .sc-tp-group-animation-s>*{opacity:0}";
const TpGroupAnimationStyle0 = groupAnimationCss;

const TpGroupAnimation$1 = /*@__PURE__*/ proxyCustomElement(class TpGroupAnimation extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        /**
    ...
    static get style() { return TpGroupAnimationStyle0; }
}, [6, "tp-group-animation", {
        "animation": [513],
        "scrollTrigger": [516, "scroll-trigger"],
        "duration": [514],
        "delay": [514],
        "stagger": [514],
        "intersectionTrigger": [514, "intersection-trigger"],
        "scroller": [513],
        "buffer": [32]
    }, undefined, {
        "buffer": ["onBufferUpdate"]
...
function defineCustomElement$1() {
    ...
    const components = ["tp-group-animation"];
    components.forEach(tagName => { switch (tagName) {
        case "tp-group-animation":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, TpGroupAnimation$1);
            }
            break;
    } });
}

const TpGroupAnimation = TpGroupAnimation$1;
const defineCustomElement = defineCustomElement$1;

export { TpGroupAnimation, defineCustomElement };

//# sourceMappingURL=tp-group-animation.js.map