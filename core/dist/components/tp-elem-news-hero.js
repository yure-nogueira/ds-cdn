...
const TpElemNewsHero$1 = /*@__PURE__*/ proxyCustomElement(class TpElemNewsHero extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
    }
    ...
    static get style() { return TpElemNewsHeroStyle0; }
}, [6, "tp-elem-news-hero"]);
function defineCustomElement$1() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["tp-elem-news-hero"];
    components.forEach(tagName => { switch (tagName) {
        case "tp-elem-news-hero":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, TpElemNewsHero$1);
            }
            break;
    } });
}

const TpElemNewsHero = TpElemNewsHero$1;
const defineCustomElement = defineCustomElement$1;

export { TpElemNewsHero, defineCustomElement };

//# sourceMappingURL=tp-elem-news-hero.js.map