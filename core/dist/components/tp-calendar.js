...
const TpCalendar$1 = /*@__PURE__*/ proxyCustomElement(class TpCalendar extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
    ...
    static get style() { return TpCalendarStyle0; }
}, [6, "tp-calendar", {
        "color": [513],
        "label": [513],
        "initialTimeframe": [513, "initial-timeframe"],
        "timeframe": [32]
    }]);
function defineCustomElement$1() {
    ...
    const components = ["tp-calendar"];
    components.forEach(tagName => { switch (tagName) {
        case "tp-calendar":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, TpCalendar$1);
            }
            break;
    } });
}

const TpCalendar = TpCalendar$1;
const defineCustomElement = defineCustomElement$1;

export { TpCalendar, defineCustomElement };

//# sourceMappingURL=tp-calendar.js.map