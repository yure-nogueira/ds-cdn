...
const TpTooltip$1 = /*@__PURE__*/ proxyCustomElement(class TpTooltip extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
    ...
    static get style() { return TpTooltipStyle0; }
}, [6, "tp-tooltip", {
        "color": [513],
        "hover": [4],
        "placement": [513],
...
function defineCustomElement$1() {
    ...
    const components = ["tp-tooltip"];
    components.forEach(tagName => { switch (tagName) {
        case "tp-tooltip":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, TpTooltip$1);
            }
            break;
    } });
}

const TpTooltip = TpTooltip$1;
const defineCustomElement = defineCustomElement$1;

export { TpTooltip, defineCustomElement };

//# sourceMappingURL=tp-tooltip.js.map