...
const TpCheckCard$1 = /*@__PURE__*/ proxyCustomElement(class TpCheckCard extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
    ...
    static get style() { return TpCheckCardStyle0; }
}, [6, "tp-check-card", {
        "color": [513],
        "alert": [516],
        "titulo": [513],
        "categoria": [513],
        "horaInicial": [513, "hora-inicial"],
        "horaFinal": [513, "hora-final"],
        "dataInicial": [513, "data-inicial"],
        "dataFinal": [513, "data-final"],
        "finalizada": [513],
...
function defineCustomElement$1() {
    ...
    const components = ["tp-check-card"];
    components.forEach(tagName => { switch (tagName) {
        case "tp-check-card":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, TpCheckCard$1);
            }
            break;
    } });
}

const TpCheckCard = TpCheckCard$1;
const defineCustomElement = defineCustomElement$1;

export { TpCheckCard, defineCustomElement };

//# sourceMappingURL=tp-check-card.js.map