...
const TP_DOWNLOAD_BUTTON = {
    icons: {
        arrowDown: getAssetPath('./assets/tp-arrow-down-filled.svg'),
    },
};
...
const TpDownloadButton$1 = /*@__PURE__*/ proxyCustomElement(class TpDownloadButton extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return TpDownloadButtonStyle0; }
}, [1, "tp-download-button", {
        "color": [513],
        "value": [514],
        "downloading": [516],
        "downloaded": [516],
...
function defineCustomElement$1() {
    ...
    const components = ["tp-download-button"];
    components.forEach(tagName => { switch (tagName) {
        case "tp-download-button":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, TpDownloadButton$1);
            }
            break;
    } });
}

const TpDownloadButton = TpDownloadButton$1;
const defineCustomElement = defineCustomElement$1;

export { TpDownloadButton, defineCustomElement };

//# sourceMappingURL=tp-download-button.js.map