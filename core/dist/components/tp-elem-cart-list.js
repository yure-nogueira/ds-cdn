...
import { d as defineCustomElement$3 } from './cart-item.js';
...
const TpElemCartList$1 = /*@__PURE__*/ proxyCustomElement(class TpElemCartList extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
    ...
    static get style() { return TpElemCartListStyle0; }
}, [2, "tp-elem-cart-list", {
        "errorMessage": [32],
        "total": [32],
        "cartItems": [32],
        "itemsData": [32]
    }, [[8, "tpChangeAlt", "handlePlusminus"], [0, "updatedCart", "handleUpdatedCartCount"]], {
        "cartItems": ["watchCartItems"]
    }]);
function defineCustomElement$1() {
    ...
    const components = ["tp-elem-cart-list", "tp-elem-cart-item", "tp-plusminus"];
    components.forEach(tagName => { switch (tagName) {
        case "tp-elem-cart-list":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, TpElemCartList$1);
            }
            break;
...
const TpElemCartList = TpElemCartList$1;
const defineCustomElement = defineCustomElement$1;

export { TpElemCartList, defineCustomElement };

//# sourceMappingURL=tp-elem-cart-list.js.map