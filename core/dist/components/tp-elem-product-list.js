...
import { O as ORDERBY, A as ApiProduct, c as currency } from './currency.filter.js';
import { d as defineCustomElement$4 } from './product-item.js';
import { d as defineCustomElement$3 } from './input-container.js';
...
const TpElemProductList$1 = /*@__PURE__*/ proxyCustomElement(class TpElemProductList extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        /**
    ...
    static get style() { return TpElemProductListStyle0; }
}, [2, "tp-elem-product-list", {
        ...
        "filter": [32],
        "loadingProducts": [32]
    }, [[0, "ionChange", "onChangeFilter"], [0, "tpNavigate", "onNavigateToPage"], [0, "tpPrevious", "onGoToPreviousPage"], [0, "tpNext", "onGoToNextPage"], [0, "tpPageJump", "onPageJump"]], {
        "filter": ["onUpdatedFilter"]
    }]);
function defineCustomElement$1() {
    ...
    const components = ["tp-elem-product-list", "tp-elem-product-item", "tp-input-container", "tp-pagination"];
    components.forEach(tagName => { switch (tagName) {
        case "tp-elem-product-list":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, TpElemProductList$1);
            }
            break;
...
const TpElemProductList = TpElemProductList$1;
const defineCustomElement = defineCustomElement$1;

export { TpElemProductList, defineCustomElement };

//# sourceMappingURL=tp-elem-product-list.js.map