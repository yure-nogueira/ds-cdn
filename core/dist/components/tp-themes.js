...
const TpThemes$1 = /*@__PURE__*/ proxyCustomElement(class TpThemes extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
    ...
    static get style() { return TpThemesStyle0; }
}, [2, "tp-themes", {
        "ativo": [513],
        "temas": [16]
    }]);
function defineCustomElement$1() {
    ...
    const components = ["tp-themes"];
    components.forEach(tagName => { switch (tagName) {
        case "tp-themes":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, TpThemes$1);
            }
            break;
    } });
}

const TpThemes = TpThemes$1;
const defineCustomElement = defineCustomElement$1;

export { TpThemes, defineCustomElement };

//# sourceMappingURL=tp-themes.js.map