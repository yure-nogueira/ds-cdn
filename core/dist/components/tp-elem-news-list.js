...
import { d as defineCustomElement$3 } from './news-item.js';
...
const TpElemNewsList$1 = /*@__PURE__*/ proxyCustomElement(class TpElemNewsList extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
    ...
    static get style() { return TpElemNewsListStyle0; }
}, [6, "tp-elem-news-list", {
        "mode": [513],
        "perPage": [514, "per-page"],
        "page": [32],
        "totalPages": [32],
        "news": [32],
        "loading": [32],
...
function defineCustomElement$1() {
    ...
    const components = ["tp-elem-news-list", "tp-elem-news-item", "tp-loader"];
    components.forEach(tagName => { switch (tagName) {
        case "tp-elem-news-list":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, TpElemNewsList$1);
            }
            break;
...
const TpElemNewsList = TpElemNewsList$1;
const defineCustomElement = defineCustomElement$1;

export { TpElemNewsList, defineCustomElement };

//# sourceMappingURL=tp-elem-news-list.js.map